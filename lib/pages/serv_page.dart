...
import 'package:adoptme/widgets/package_card_contrac_vet.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:gap/gap.dart';

class ServPage extends StatefulWidget {
  const ServPage({Key? key}) : super(key: key);
            ...
            MediaQuery.removeViewPadding(
              ...
              child: AnimatedList(
                  ...
                  itemBuilder: (c, i, animation) {
                    final package = VeterinaryDetails.fromJson(groomingList[i]);
                    return SlideTransition(
                      ...
                      child: PackageCardContracVet(package),
                    );
                  }),
