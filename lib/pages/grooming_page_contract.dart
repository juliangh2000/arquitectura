...
class GroomingContractPage extends StatefulWidget {
  const GroomingContractPage({Key? key}) : super(key: key);

  @override
  State<GroomingContractPage> createState() => _GroomingContractPageState();
}

class _GroomingContractPageState extends State<GroomingContractPage> {
  List groomingList = [
    {
      'name': 'Paseo',
      'services': 12,
                    ...
                    builder: (context, value, _) {
                      return Stack(
                        children: [
                          ...
                          MaterialPageRoute(builder: (_) => const GroomingContractPage()));
