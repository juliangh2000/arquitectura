...
import 'package:adoptme/widgets/package_card_novedades.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:gap/gap.dart';

class NovedadPage extends StatefulWidget {
  const NovedadPage({Key? key}) : super(key: key);

  @override
  State<NovedadPage> createState() => _NovedadPageState();
}

class _NovedadPageState extends State<NovedadPage> {
  List groomingList = [
      {
      'name': 'Paseo',
      'services': 12,
              ...
              child: AnimatedList(
                  ...
                  itemBuilder: (c, i, animation) {
                    ...
                    return SlideTransition(
                      ...
                      child: PackageCardNovedades(package),
                    );
                  }),
