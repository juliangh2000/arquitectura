    ...
    return FittedBox(
      child: Container(
          ...
          decoration: BoxDecoration(
              color: Styles.bgColor, borderRadius: BorderRadius.circular(17)),
          padding:
              const EdgeInsets.only(left: 16, right: 12, top: 14, bottom: 7),
          child: Row(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      vetItem.pet == null
                          ? const Gap(0)
                          : SvgPicture.asset(vetItem.pet!, height: 30),
                    ],
                  ),
                  const Gap(15),
                  Column(
